...
namespace Solar_system_Nudel.Classes.OpenGLFolder
{
    ...
    public struct GLUquadric { public nint data; }
    public class GLU
    {
        ...
        public static extern void gluQuadricCallback(GLUquadric qobj, uint which, nint fn);
        [DllImport(GLU_DLL, EntryPoint = "gluNewTess")]
        public static extern nint gluNewTess();
        [DllImport(GLU_DLL, EntryPoint = "gluDeleteTess")]
        public static extern void gluDeleteTess(nint tess);
        [DllImport(GLU_DLL, EntryPoint = "gluTessBeginPolygon")]
        public static extern void gluTessBeginPolygon(nint tess, object polygon_data);
        [DllImport(GLU_DLL, EntryPoint = "gluTessBeginContour")]
        public static extern void gluTessBeginContour(nint tess);
        [DllImport(GLU_DLL, EntryPoint = "gluTessVertex")]
        public static extern void gluTessVertex(nint tess, double coords, object data);
        [DllImport(GLU_DLL, EntryPoint = "gluTessEndContour")]
        public static extern void gluTessEndContour(nint tess);
        [DllImport(GLU_DLL, EntryPoint = "gluTessEndPolygon")]
        public static extern void gluTessEndPolygon(nint tess);
        [DllImport(GLU_DLL, EntryPoint = "gluTessProperty")]
        public static extern void gluTessProperty(nint tess, uint which, double valuex);
        [DllImport(GLU_DLL, EntryPoint = "gluTessNormal")]
        public static extern void gluTessNormal(nint tess, double x, double y, double z);
        [DllImport(GLU_DLL, EntryPoint = "gluTessCallback")]
        public static extern void gluTessCallback(nint tess, uint which, nint fn);
        [DllImport(GLU_DLL, EntryPoint = "gluGetTessProperty")]
        public static extern void gluGetTessProperty(nint tess, uint which, ref double valuex);
        [DllImport(GLU_DLL, EntryPoint = "gluNewNurbsRenderer")]
        public static extern nint gluNewNurbsRenderer();
        [DllImport(GLU_DLL, EntryPoint = "gluDeleteNurbsRenderer")]
        public static extern void gluDeleteNurbsRenderer(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluBeginSurface")]
        public static extern void gluBeginSurface(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluBeginCurve")]
        public static extern void gluBeginCurve(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluEndCurve")]
        public static extern void gluEndCurve(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluEndSurface")]
        public static extern void gluEndSurface(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluBeginTrim")]
        public static extern void gluBeginTrim(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluEndTrim")]
        public static extern void gluEndTrim(nint nobj);
        [DllImport(GLU_DLL, EntryPoint = "gluPwlCurve")]
        public static extern void gluPwlCurve(nint nobj, int count, float[] array, int stride, uint type);
        [DllImport(GLU_DLL, EntryPoint = "gluNurbsCurve")]
        public static extern void gluNurbsCurve(nint nobj, int nknots, float[] knot, int stride, float[] ctlarray, int order, uint type);
        [DllImport(GLU_DLL, EntryPoint = "gluNurbsSurface")]
        public static extern void gluNurbsSurface(nint nobj, int sknot_count, float[] sknot, int tknot_count, float[] tknot, int s_stride, int t_stride, float[] ctlarray, int sorder, int torder, uint type);
        [DllImport(GLU_DLL, EntryPoint = "gluLoadSamplingMatrices")]
        public static extern void gluLoadSamplingMatrices(nint nobj, float modelMatrix, float projMatrix, int viewport);
        [DllImport(GLU_DLL, EntryPoint = "gluNurbsProperty")]
        public static extern void gluNurbsProperty(nint nobj, uint property, float valuex);
        [DllImport(GLU_DLL, EntryPoint = "gluGetNurbsProperty")]
        public static extern void gluGetNurbsProperty(nint nobj, uint property, float[] valuex);
        [DllImport(GLU_DLL, EntryPoint = "gluNurbsCallback")]
        public static extern void gluNurbsCallback(nint nobj, uint which, nint fn);
        [DllImport(GLU_DLL, EntryPoint = "gluBeginPolygon")]
        public static extern void gluBeginPolygon(nint tess);
        [DllImport(GLU_DLL, EntryPoint = "gluNextContour")]
        public static extern void gluNextContour(nint tess, uint type);
